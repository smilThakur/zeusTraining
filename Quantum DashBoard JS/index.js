...
const alertJsonFilePath = "./alertData.json"
const annoucementJsonFilePath = "./announcementData.json"
const courseJsonFilePath = "./courseData.json"

let alert_data = []
let announcement_data = []
let course_card_data = []

const fetchAlertJson = async () => {

    try {
        var response = await fetch(alertJsonFilePath);
...
const fetchAnnouncementJson = async () => {

    try {
        var response = await fetch(annoucementJsonFilePath)
...
const fetchCourseJson = async () => {

    try {
        var response = await fetch(courseJsonFilePath)
